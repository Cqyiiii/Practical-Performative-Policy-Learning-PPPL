...
for cost_coef in [0.1, 0.15, 0.2]:
    ...
    for rep_index in range(repeat_num):
        ...
        result_strategicGD = strategicGD(data_list, data_eval, dim_v, card_u, H, len_seq, num_epoch, lr_pi=lr_pi, lr_prob = lr_prob,  seed=seed, cost_coef = cost_coef)
        result_vanillaGD = vanillaGD(data_list, data_eval, dim_v, card_u, H_prime, seed=seed, lr_pi = lr_pi, cost_coef = cost_coef)
